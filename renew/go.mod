...
require (
	...
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.139 // indirect
	gitlab.dev.wopta.it/goworkspace/document v1.1.285 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.329 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.127 // indirect
