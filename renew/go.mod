...
require (
	...
	github.com/wopta/goworkspace/document v1.1.115 // indirect
	github.com/wopta/goworkspace/network v1.0.90 // indirect
	github.com/wopta/goworkspace/policy v1.0.150 // indirect
