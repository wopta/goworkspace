...
require (
	...
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.192 // indirect
	gitlab.dev.wopta.it/goworkspace/document v1.1.348 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.392 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.178 // indirect
	gitlab.dev.wopta.it/goworkspace/wiseproxy v1.0.78 // indirect
