...
require (
	...
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.168 // indirect
	gitlab.dev.wopta.it/goworkspace/document v1.1.320 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.364 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.156 // indirect
