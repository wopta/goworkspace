...
require (
	...
	github.com/wopta/goworkspace/network v1.0.105 // indirect
	github.com/wopta/goworkspace/policy v1.0.188 // indirect
	github.com/wopta/goworkspace/product v1.1.37 // indirect
