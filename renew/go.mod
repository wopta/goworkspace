...
require (
	...
	gitlab.dev.wopta.it/goworkspace/payment v1.0.537
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.375
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.203 // indirect
