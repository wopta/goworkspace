...
require (
	...
	github.com/wopta/goworkspace/document v1.1.134 // indirect
	github.com/wopta/goworkspace/network v1.0.100 // indirect
	github.com/wopta/goworkspace/policy v1.0.174 // indirect
	github.com/wopta/goworkspace/product v1.1.32 // indirect
