...
require (
	...
	gitlab.dev.wopta.it/goworkspace/payment v1.0.478
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.152 // indirect
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.141 // indirect
