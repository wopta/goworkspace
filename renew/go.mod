...
require (
	...
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.135 // indirect
	gitlab.dev.wopta.it/goworkspace/document v1.1.281 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.325 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.123 // indirect
