...
require (
	...
	github.com/wopta/goworkspace/document v1.1.71 // indirect
	github.com/wopta/goworkspace/network v1.0.55 // indirect
	github.com/wopta/goworkspace/policy v1.0.95 // indirect
	github.com/wopta/goworkspace/product v1.0.101 // indirect
