...
require (
	...
	gitlab.dev.wopta.it/goworkspace/payment v1.0.505
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.178 // indirect
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.161 // indirect
