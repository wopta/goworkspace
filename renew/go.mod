...
require (
	...
	gitlab.dev.wopta.it/goworkspace/payment v1.0.393
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.244
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.72 // indirect
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.82 // indirect
	gitlab.dev.wopta.it/goworkspace/document v1.1.207 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.251 // indirect
