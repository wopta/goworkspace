...
require (
	...
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.144 // indirect
	gitlab.dev.wopta.it/goworkspace/document v1.1.293 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.337 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.132 // indirect
