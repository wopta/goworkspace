...
require (
	...
	github.com/wopta/goworkspace/document v1.1.116 // indirect
	github.com/wopta/goworkspace/network v1.0.91 // indirect
	github.com/wopta/goworkspace/policy v1.0.152 // indirect
