...
require (
	...
	gitlab.dev.wopta.it/goworkspace/payment v1.0.513
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.183 // indirect
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.166 // indirect
