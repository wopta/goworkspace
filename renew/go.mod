...
require (
	...
	github.com/wopta/goworkspace/document v1.1.112 // indirect
	github.com/wopta/goworkspace/network v1.0.88 // indirect
	github.com/wopta/goworkspace/policy v1.0.144 // indirect
	github.com/wopta/goworkspace/product v1.1.21 // indirect
