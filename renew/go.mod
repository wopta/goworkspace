...
require (
	...
	gitlab.dev.wopta.it/goworkspace/payment v1.0.536
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.374
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.202 // indirect
