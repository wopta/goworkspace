...
require (
	...
	gitlab.dev.wopta.it/goworkspace/payment v1.0.477
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.151 // indirect
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.140 // indirect
