...
require (
	...
	gitlab.dev.wopta.it/goworkspace/payment v1.0.504
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.177 // indirect
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.160 // indirect
