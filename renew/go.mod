...
require (
	...
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.204 // indirect
	gitlab.dev.wopta.it/goworkspace/document v1.1.361 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.405 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.190 // indirect
	gitlab.dev.wopta.it/goworkspace/wiseproxy v1.0.87 // indirect
