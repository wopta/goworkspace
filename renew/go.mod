...
require (
	...
	gitlab.dev.wopta.it/goworkspace/payment v1.0.401
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.252
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.80 // indirect
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.86 // indirect
	gitlab.dev.wopta.it/goworkspace/document v1.1.215 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.259 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.74 // indirect
	gitlab.dev.wopta.it/goworkspace/wiseproxy v1.0.16 // indirect
