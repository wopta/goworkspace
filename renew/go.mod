...
require (
	...
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.136 // indirect
	gitlab.dev.wopta.it/goworkspace/document v1.1.282 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.326 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.124 // indirect
