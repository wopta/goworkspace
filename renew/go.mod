...
require (
	...
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.133 // indirect
	gitlab.dev.wopta.it/goworkspace/document v1.1.279 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.323 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.121 // indirect
