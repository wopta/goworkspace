...
require (
	...
	github.com/wopta/goworkspace/document v1.1.109 // indirect
	github.com/wopta/goworkspace/network v1.0.85 // indirect
	github.com/wopta/goworkspace/policy v1.0.139 // indirect
	github.com/wopta/goworkspace/product v1.1.18 // indirect
