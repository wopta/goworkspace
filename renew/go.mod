...
require (
	...
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.129 // indirect
	gitlab.dev.wopta.it/goworkspace/document v1.1.275 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.318 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.117 // indirect
