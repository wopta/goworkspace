...
require (
	...
	github.com/wopta/goworkspace/network v1.0.108 // indirect
	github.com/wopta/goworkspace/policy v1.0.191 // indirect
	github.com/wopta/goworkspace/product v1.1.40 // indirect
