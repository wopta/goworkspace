...
require (
	...
	github.com/wopta/goworkspace/network v1.0.116 // indirect
	github.com/wopta/goworkspace/policy v1.0.200 // indirect
	github.com/wopta/goworkspace/product v1.1.48 // indirect
