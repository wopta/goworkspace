...
require (
	...
	gitlab.dev.wopta.it/goworkspace/mail v1.0.229
	gitlab.dev.wopta.it/goworkspace/models v1.2.107
	gitlab.dev.wopta.it/goworkspace/network v1.0.175
	gitlab.dev.wopta.it/goworkspace/payment v1.0.444
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.292
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.120 // indirect
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.118 // indirect
	gitlab.dev.wopta.it/goworkspace/document v1.1.256 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.299 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.106 // indirect
