...
require (
	...
	gitlab.dev.wopta.it/goworkspace/payment v1.0.443
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.291
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.119 // indirect
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.118 // indirect
	gitlab.dev.wopta.it/goworkspace/document v1.1.255 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.298 // indirect
