...
require (
	...
	github.com/wopta/goworkspace/document v1.1.104 // indirect
	github.com/wopta/goworkspace/network v1.0.80 // indirect
	github.com/wopta/goworkspace/policy v1.0.133 // indirect
	github.com/wopta/goworkspace/product v1.1.13 // indirect
