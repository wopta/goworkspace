...
require (
	...
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.151 // indirect
	gitlab.dev.wopta.it/goworkspace/document v1.1.303 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.347 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.139 // indirect
