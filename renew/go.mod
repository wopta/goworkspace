...
require (
	...
	github.com/wopta/goworkspace/document v1.1.86 // indirect
	github.com/wopta/goworkspace/network v1.0.71 // indirect
	github.com/wopta/goworkspace/policy v1.0.114 // indirect
	github.com/wopta/goworkspace/product v1.1.2 // indirect
