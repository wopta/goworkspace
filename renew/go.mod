...
require (
	...
	github.com/wopta/goworkspace/payment v1.0.290-hotfix.4
	github.com/wopta/goworkspace/transaction v1.0.153-hotfix.3
...
require (
	...
	github.com/wopta/goworkspace/callback_out v1.0.43 // indirect
