...
require (
	...
	gitlab.dev.wopta.it/goworkspace/mail v1.0.221
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.111 // indirect
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.110 // indirect
