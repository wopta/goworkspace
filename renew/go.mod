...
require (
	...
	github.com/wopta/goworkspace/document v1.1.82 // indirect
	github.com/wopta/goworkspace/network v1.0.67 // indirect
	github.com/wopta/goworkspace/policy v1.0.106 // indirect
	github.com/wopta/goworkspace/product v1.0.113 // indirect
