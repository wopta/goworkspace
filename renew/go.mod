...
require (
	...
	github.com/wopta/goworkspace/network v1.0.106 // indirect
	github.com/wopta/goworkspace/policy v1.0.189 // indirect
	github.com/wopta/goworkspace/product v1.1.38 // indirect
