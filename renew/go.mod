...
require (
	...
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.191 // indirect
	gitlab.dev.wopta.it/goworkspace/document v1.1.347 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.391 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.177 // indirect
	gitlab.dev.wopta.it/goworkspace/wiseproxy v1.0.77 // indirect
