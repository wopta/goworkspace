...
require (
	...
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.107 // indirect
	gitlab.dev.wopta.it/goworkspace/document v1.1.242 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.285 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.95 // indirect
