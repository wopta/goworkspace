...
require (
	...
	github.com/wopta/goworkspace/document v1.1.110 // indirect
	github.com/wopta/goworkspace/network v1.0.86 // indirect
	github.com/wopta/goworkspace/policy v1.0.140 // indirect
	github.com/wopta/goworkspace/product v1.1.19 // indirect
