...
require (
	...
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.156 // indirect
	gitlab.dev.wopta.it/goworkspace/document v1.1.308 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.352 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.144 // indirect
