...
require (
	...
	gitlab.dev.wopta.it/goworkspace/mail v1.0.196
	gitlab.dev.wopta.it/goworkspace/models v1.2.77
	gitlab.dev.wopta.it/goworkspace/network v1.0.143
	gitlab.dev.wopta.it/goworkspace/payment v1.0.405
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.254
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.82 // indirect
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.88 // indirect
	gitlab.dev.wopta.it/goworkspace/document v1.1.217 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.261 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.76 // indirect
