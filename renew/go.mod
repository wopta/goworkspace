...
require (
	...
	gitlab.dev.wopta.it/goworkspace/payment v1.0.535
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.373
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.201 // indirect
