...
require (
	...
	gitlab.dev.wopta.it/goworkspace/payment v1.0.391
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.242
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.70 // indirect
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.82 // indirect
	gitlab.dev.wopta.it/goworkspace/document v1.1.205 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.249 // indirect
