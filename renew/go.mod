...
require (
	...
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.208 // indirect
	gitlab.dev.wopta.it/goworkspace/document v1.1.365 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.409 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.194 // indirect
	gitlab.dev.wopta.it/goworkspace/wiseproxy v1.0.91 // indirect
