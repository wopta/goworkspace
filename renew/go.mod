...
require (
	...
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.109 // indirect
	gitlab.dev.wopta.it/goworkspace/document v1.1.246 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.289 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.97 // indirect
