...
require (
	...
	github.com/wopta/goworkspace/document v1.1.105 // indirect
	github.com/wopta/goworkspace/network v1.0.81 // indirect
	github.com/wopta/goworkspace/policy v1.0.134 // indirect
	github.com/wopta/goworkspace/product v1.1.14 // indirect
