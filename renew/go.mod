...
require (
	...
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.134 // indirect
	gitlab.dev.wopta.it/goworkspace/document v1.1.280 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.324 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.122 // indirect
