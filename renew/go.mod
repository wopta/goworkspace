...
require (
	...
	github.com/wopta/goworkspace/document v1.1.106 // indirect
	github.com/wopta/goworkspace/network v1.0.82 // indirect
	github.com/wopta/goworkspace/policy v1.0.135 // indirect
	github.com/wopta/goworkspace/product v1.1.15 // indirect
