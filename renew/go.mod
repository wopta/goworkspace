...
require (
	...
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.209 // indirect
	gitlab.dev.wopta.it/goworkspace/document v1.1.366 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.410 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.195 // indirect
	gitlab.dev.wopta.it/goworkspace/wiseproxy v1.0.92 // indirect
