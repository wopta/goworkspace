...
require (
	...
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.128 // indirect
	gitlab.dev.wopta.it/goworkspace/document v1.1.274 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.317 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.116 // indirect
