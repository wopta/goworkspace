...
require (
	...
	gitlab.dev.wopta.it/goworkspace/payment v1.0.392
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.243
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.71 // indirect
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.82 // indirect
	gitlab.dev.wopta.it/goworkspace/document v1.1.206 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.250 // indirect
