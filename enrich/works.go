...
func getWork() []byte {
	...
	Addetto in birrerie, paninoteche;2;x;x;
	Addetto pulizie in hotel/Alberghi;2;x;x;
	Addetto rivendita Gas in bombole, Olio Combustibile;3;x;x;
	Addetto stampa / pubblicità;2;x;x;
	Addetto/operatore di Laboratorio (senza uso e/o contatto con sostanze radioattive/nucleari o pericolose in genere);2;x;x;
	Addetto/operatore stazioni di Lavaggio;3;x;x;
	Agente di Cambio;1;x;x;
	Agronomo;2;x;x;
	Allevatore;3;x;x;
