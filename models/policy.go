...
type Policy struct {
	...
	ReservedMotives    []string                     `json:"reservedMotives,omitempty" firestore:"reservedMotives,omitempty" bigquery:"-"`
	BigReservedMotives string                       `json:"-" firestore:"-" bigquery:"reservedMotives"`
