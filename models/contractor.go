...
type Contractor struct {
	...
	IsFamilyMember           bool                   `firestore:"isFamilyMember"              json:"isFamilyMember"              bigquery:"-"`
	IsContactable            bool                   `firestore:"isContactable"               json:"isContactable"               bigquery:"-"`
	Ateco                    string                 `firestore:"ateco"                       json:"ateco"                       bigquery:"-"`
	CompanyName              string                 `firestore:"companyName"                 json:"companyName"                 bigquery:"-"`
}
