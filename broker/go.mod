...
require (
	...
	gitlab.dev.wopta.it/goworkspace/document v1.1.296
	...
	gitlab.dev.wopta.it/goworkspace/payment v1.0.487
	gitlab.dev.wopta.it/goworkspace/policy v1.0.340
	gitlab.dev.wopta.it/goworkspace/product v1.1.133
	gitlab.dev.wopta.it/goworkspace/question v1.0.188
	gitlab.dev.wopta.it/goworkspace/reserved v1.0.347
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.333
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.161 // indirect
