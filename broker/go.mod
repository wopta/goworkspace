...
require (
	...
	gitlab.dev.wopta.it/goworkspace/bpmn v1.0.70
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.101
	gitlab.dev.wopta.it/goworkspace/document v1.1.236
	...
	gitlab.dev.wopta.it/goworkspace/payment v1.0.424
	gitlab.dev.wopta.it/goworkspace/policy v1.0.279
	gitlab.dev.wopta.it/goworkspace/product v1.1.89
	gitlab.dev.wopta.it/goworkspace/question v1.0.142
	gitlab.dev.wopta.it/goworkspace/reserved v1.0.286
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.272
	gitlab.dev.wopta.it/goworkspace/wiseproxy v1.0.30
)
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.100 // indirect
