...
require (
	...
	gitlab.dev.wopta.it/goworkspace/bpmn v1.0.41
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.72
	gitlab.dev.wopta.it/goworkspace/document v1.1.182
	gitlab.dev.wopta.it/goworkspace/lib v1.0.166
	gitlab.dev.wopta.it/goworkspace/mail v1.0.178
	gitlab.dev.wopta.it/goworkspace/models v1.2.61
	gitlab.dev.wopta.it/goworkspace/network v1.0.127
	gitlab.dev.wopta.it/goworkspace/payment v1.0.365
	gitlab.dev.wopta.it/goworkspace/policy v1.0.227
	gitlab.dev.wopta.it/goworkspace/product v1.1.59
	gitlab.dev.wopta.it/goworkspace/question v1.0.113
	gitlab.dev.wopta.it/goworkspace/reserved v1.0.233
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.220
