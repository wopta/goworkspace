...
require (
	...
	gitlab.dev.wopta.it/goworkspace/document v1.1.327
	...
	gitlab.dev.wopta.it/goworkspace/question v1.0.218
	gitlab.dev.wopta.it/goworkspace/reserved v1.0.378
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.364
	gitlab.dev.wopta.it/goworkspace/wiseproxy v1.0.63
)
