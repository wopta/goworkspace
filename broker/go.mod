...
require (
	...
	gitlab.dev.wopta.it/goworkspace/bpmn v1.0.132
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.161
	...
	gitlab.dev.wopta.it/goworkspace/question v1.0.204
	gitlab.dev.wopta.it/goworkspace/reserved v1.0.364
