...
require (
	...
	gitlab.dev.wopta.it/goworkspace/payment v1.0.433
	...
	gitlab.dev.wopta.it/goworkspace/reserved v1.0.295
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.109 // indirect
