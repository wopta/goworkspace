...
require (
	...
	gitlab.dev.wopta.it/goworkspace/document v1.1.221
	...
	gitlab.dev.wopta.it/goworkspace/question v1.0.131
	gitlab.dev.wopta.it/goworkspace/reserved v1.0.271
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.257
	gitlab.dev.wopta.it/goworkspace/wiseproxy v1.0.19
)
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.85 // indirect
