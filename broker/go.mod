...
require (
	...
	gitlab.dev.wopta.it/goworkspace/bpmn v1.0.174
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.203
	gitlab.dev.wopta.it/goworkspace/document v1.1.360
	gitlab.dev.wopta.it/goworkspace/lib v1.0.244
	gitlab.dev.wopta.it/goworkspace/mail v1.0.314
	gitlab.dev.wopta.it/goworkspace/models v1.2.190
	gitlab.dev.wopta.it/goworkspace/network v1.0.258
	gitlab.dev.wopta.it/goworkspace/payment v1.0.559
	gitlab.dev.wopta.it/goworkspace/policy v1.0.404
	gitlab.dev.wopta.it/goworkspace/product v1.1.189
	gitlab.dev.wopta.it/goworkspace/question v1.0.244
	gitlab.dev.wopta.it/goworkspace/reserved v1.0.411
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.397
	gitlab.dev.wopta.it/goworkspace/wiseproxy v1.0.86
)
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.225 // indirect
