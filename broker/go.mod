...
require (
	...
	gitlab.dev.wopta.it/goworkspace/bpmn v1.0.90
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.121
	gitlab.dev.wopta.it/goworkspace/document v1.1.260
	...
	gitlab.dev.wopta.it/goworkspace/question v1.0.164
	gitlab.dev.wopta.it/goworkspace/reserved v1.0.310
