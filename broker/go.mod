...
require (
	...
	gitlab.dev.wopta.it/goworkspace/bpmn v1.0.58
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.89
	gitlab.dev.wopta.it/goworkspace/document v1.1.220
	gitlab.dev.wopta.it/goworkspace/lib v1.0.176
	gitlab.dev.wopta.it/goworkspace/mail v1.0.199
	gitlab.dev.wopta.it/goworkspace/models v1.2.78
	gitlab.dev.wopta.it/goworkspace/network v1.0.146
	gitlab.dev.wopta.it/goworkspace/payment v1.0.407
	gitlab.dev.wopta.it/goworkspace/policy v1.0.263
	gitlab.dev.wopta.it/goworkspace/product v1.1.77
	gitlab.dev.wopta.it/goworkspace/question v1.0.130
	gitlab.dev.wopta.it/goworkspace/reserved v1.0.270
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.256
	gitlab.dev.wopta.it/goworkspace/wiseproxy v1.0.18
)
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.84 // indirect
