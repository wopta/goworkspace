...
require (
	...
	gitlab.dev.wopta.it/goworkspace/bpmn v1.0.124
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.153
	gitlab.dev.wopta.it/goworkspace/document v1.1.305
	...
	gitlab.dev.wopta.it/goworkspace/payment v1.0.497
	gitlab.dev.wopta.it/goworkspace/policy v1.0.349
	gitlab.dev.wopta.it/goworkspace/product v1.1.141
	gitlab.dev.wopta.it/goworkspace/question v1.0.196
	gitlab.dev.wopta.it/goworkspace/reserved v1.0.356
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.342
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.170 // indirect
