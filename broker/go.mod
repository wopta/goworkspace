...
require (
	...
	gitlab.dev.wopta.it/goworkspace/bpmn v1.0.52
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.83
	gitlab.dev.wopta.it/goworkspace/document v1.1.208
	gitlab.dev.wopta.it/goworkspace/lib v1.0.171
	gitlab.dev.wopta.it/goworkspace/mail v1.0.189
	gitlab.dev.wopta.it/goworkspace/models v1.2.72
	gitlab.dev.wopta.it/goworkspace/network v1.0.138
	gitlab.dev.wopta.it/goworkspace/payment v1.0.394
	gitlab.dev.wopta.it/goworkspace/policy v1.0.252
	gitlab.dev.wopta.it/goworkspace/product v1.1.71
	gitlab.dev.wopta.it/goworkspace/question v1.0.124
	gitlab.dev.wopta.it/goworkspace/reserved v1.0.259
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.245
	gitlab.dev.wopta.it/goworkspace/wiseproxy v1.0.13
)
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.73 // indirect
