...
require (
	...
	gitlab.dev.wopta.it/goworkspace/bpmn v1.0.131
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.160
	...
	gitlab.dev.wopta.it/goworkspace/question v1.0.203
	gitlab.dev.wopta.it/goworkspace/reserved v1.0.363
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.349
	gitlab.dev.wopta.it/goworkspace/wiseproxy v1.0.51
)
