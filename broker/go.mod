...
require (
	...
	gitlab.dev.wopta.it/goworkspace/bpmn v1.0.114
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.145
	gitlab.dev.wopta.it/goworkspace/document v1.1.294
	gitlab.dev.wopta.it/goworkspace/lib v1.0.200
	gitlab.dev.wopta.it/goworkspace/mail v1.0.258
	gitlab.dev.wopta.it/goworkspace/models v1.2.134
	gitlab.dev.wopta.it/goworkspace/network v1.0.202
	gitlab.dev.wopta.it/goworkspace/payment v1.0.485
	gitlab.dev.wopta.it/goworkspace/policy v1.0.338
	gitlab.dev.wopta.it/goworkspace/product v1.1.133
	gitlab.dev.wopta.it/goworkspace/question v1.0.188
	gitlab.dev.wopta.it/goworkspace/reserved v1.0.345
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.331
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.159 // indirect
