...
require (
	...
	gitlab.dev.wopta.it/goworkspace/bpmn v1.0.123
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.152
	gitlab.dev.wopta.it/goworkspace/document v1.1.304
	...
	gitlab.dev.wopta.it/goworkspace/payment v1.0.496
	gitlab.dev.wopta.it/goworkspace/policy v1.0.348
	gitlab.dev.wopta.it/goworkspace/product v1.1.140
	gitlab.dev.wopta.it/goworkspace/question v1.0.195
	gitlab.dev.wopta.it/goworkspace/reserved v1.0.355
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.341
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.169 // indirect
