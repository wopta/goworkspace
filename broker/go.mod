...
require (
	...
	github.com/wopta/goworkspace/document v1.0.1
	github.com/wopta/goworkspace/lib v1.0.0
	github.com/wopta/goworkspace/mail v1.0.2
	github.com/wopta/goworkspace/models v1.0.2
	github.com/wopta/goworkspace/payment v1.0.1
)

require (
	cloud.google.com/go/bigquery v1.47.0 // indirect
	...
	github.com/wopta/goworkspace/product v1.0.0 // indirect
