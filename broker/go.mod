...
require (
	...
	gitlab.dev.wopta.it/goworkspace/payment v1.0.432
	...
	gitlab.dev.wopta.it/goworkspace/reserved v1.0.294
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.108 // indirect
