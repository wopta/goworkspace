...
require (
	...
	gitlab.dev.wopta.it/goworkspace/bpmn v1.0.40
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.71
	gitlab.dev.wopta.it/goworkspace/document v1.1.181
	...
	gitlab.dev.wopta.it/goworkspace/payment v1.0.363
	gitlab.dev.wopta.it/goworkspace/policy v1.0.225
	gitlab.dev.wopta.it/goworkspace/product v1.1.58
	gitlab.dev.wopta.it/goworkspace/question v1.0.112
	gitlab.dev.wopta.it/goworkspace/reserved v1.0.231
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.217
