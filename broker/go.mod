...
require (
	...
	gitlab.dev.wopta.it/goworkspace/document v1.1.328
	...
	gitlab.dev.wopta.it/goworkspace/question v1.0.219
	gitlab.dev.wopta.it/goworkspace/reserved v1.0.379
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.365
	gitlab.dev.wopta.it/goworkspace/wiseproxy v1.0.64
)
