...
require (
	...
	gitlab.dev.wopta.it/goworkspace/document v1.1.342
	...
	gitlab.dev.wopta.it/goworkspace/payment v1.0.541
	gitlab.dev.wopta.it/goworkspace/policy v1.0.386
	gitlab.dev.wopta.it/goworkspace/product v1.1.173
	gitlab.dev.wopta.it/goworkspace/question v1.0.228
	gitlab.dev.wopta.it/goworkspace/reserved v1.0.393
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.379
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.207 // indirect
