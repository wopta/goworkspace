...
require (
	...
	gitlab.dev.wopta.it/goworkspace/document v1.1.295
	...
	gitlab.dev.wopta.it/goworkspace/payment v1.0.486
	gitlab.dev.wopta.it/goworkspace/policy v1.0.339
	gitlab.dev.wopta.it/goworkspace/product v1.1.133
	gitlab.dev.wopta.it/goworkspace/question v1.0.188
	gitlab.dev.wopta.it/goworkspace/reserved v1.0.346
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.332
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.160 // indirect
