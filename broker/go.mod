...
require (
	...
	gitlab.dev.wopta.it/goworkspace/document v1.1.258
	...
	gitlab.dev.wopta.it/goworkspace/payment v1.0.446
	gitlab.dev.wopta.it/goworkspace/policy v1.0.301
	gitlab.dev.wopta.it/goworkspace/product v1.1.107
	gitlab.dev.wopta.it/goworkspace/question v1.0.162
	gitlab.dev.wopta.it/goworkspace/reserved v1.0.308
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.294
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.122 // indirect
