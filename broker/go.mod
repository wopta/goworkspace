...
require (
	...
	github.com/wopta/goworkspace/document v1.0.51
	github.com/wopta/goworkspace/lib v1.0.40
	github.com/wopta/goworkspace/mail v1.0.19
	github.com/wopta/goworkspace/models v1.0.80
	github.com/wopta/goworkspace/payment v1.0.24
	github.com/wopta/goworkspace/user v1.0.5
