...
require (
	...
	gitlab.dev.wopta.it/goworkspace/bpmn v1.0.137
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.166
	gitlab.dev.wopta.it/goworkspace/document v1.1.318
	...
	gitlab.dev.wopta.it/goworkspace/question v1.0.209
	gitlab.dev.wopta.it/goworkspace/reserved v1.0.369
	gitlab.dev.wopta.it/goworkspace/transaction v1.0.355
	gitlab.dev.wopta.it/goworkspace/wiseproxy v1.0.54
)
