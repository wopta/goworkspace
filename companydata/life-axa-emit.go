...
func getHeader() []string {
	return []string{
		...
		"Natura del rapporto ",
		"Scopo del rapporto ",
		"Modalita' di pagamento del premio assicurativo (all intermediario) ",
		...
		"Cab della citta' di residenza dell contraente",
		"Sottogruppo attivita' economica",
		"Ramo gruppo attivita' economica",
		...
		"PEP - Persona Politicamente Esposta",
		"Tipologia di PEP",
		"Modalita' di comunicazione prescelta tra Compagnia ed contraente",
		"Indirizzo di residenza ",
		"C.A.P. Residenza ",
		"Comune Residenza ",
		"Provincia Residenza ",
