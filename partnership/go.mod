...
require (
	...
	github.com/wopta/goworkspace/quote v1.0.29
	github.com/wopta/goworkspace/user v1.0.51
)
...
require (
	...
	github.com/wopta/goworkspace/mail v1.0.70 // indirect
	github.com/wopta/goworkspace/sellable v1.0.49 // indirect
