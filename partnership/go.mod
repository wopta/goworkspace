...
require (
	...
	github.com/wopta/goworkspace/quote v1.0.45
	github.com/wopta/goworkspace/user v1.0.68
)
...
require (
	...
	github.com/wopta/goworkspace/mail v1.0.86 // indirect
	github.com/wopta/goworkspace/sellable v1.0.66 // indirect
