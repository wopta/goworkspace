...
require (
	...
	github.com/wopta/goworkspace/quote v1.0.16
	github.com/wopta/goworkspace/user v1.0.40
)
...
require (
	...
	github.com/wopta/goworkspace/mail v1.0.59 // indirect
	github.com/wopta/goworkspace/sellable v1.0.39 // indirect
