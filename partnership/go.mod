...
require (
	...
	github.com/wopta/goworkspace/quote v1.0.67-renew
...
require (
	...
	github.com/wopta/goworkspace/mail v1.0.107-renew // indirect
	github.com/wopta/goworkspace/sellable v1.0.86-renew // indirect
