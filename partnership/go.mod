...
require (
	...
	github.com/wopta/goworkspace/quote v1.0.44
	github.com/wopta/goworkspace/user v1.0.67
)
...
require (
	...
	github.com/wopta/goworkspace/mail v1.0.85 // indirect
	github.com/wopta/goworkspace/sellable v1.0.65 // indirect
