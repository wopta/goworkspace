...
require (
	...
	github.com/wopta/goworkspace/quote v1.0.63
	github.com/wopta/goworkspace/user v1.0.88
)
...
require (
	...
	github.com/wopta/goworkspace/mail v1.0.103 // indirect
	github.com/wopta/goworkspace/sellable v1.0.82 // indirect
