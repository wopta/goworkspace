...
require (
	...
	github.com/wopta/goworkspace/quote v1.0.35
	github.com/wopta/goworkspace/user v1.0.59
)
...
require (
	...
	github.com/wopta/goworkspace/mail v1.0.79 // indirect
	github.com/wopta/goworkspace/sellable v1.0.57 // indirect
