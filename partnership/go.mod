...
require (
	...
	github.com/wopta/goworkspace/quote v1.0.46
	github.com/wopta/goworkspace/user v1.0.69
)
...
require (
	...
	github.com/wopta/goworkspace/mail v1.0.87 // indirect
	github.com/wopta/goworkspace/sellable v1.0.67 // indirect
