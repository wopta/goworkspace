...
require (
	...
	github.com/wopta/goworkspace/quote v1.0.61
	github.com/wopta/goworkspace/user v1.0.86
)
...
require (
	...
	github.com/wopta/goworkspace/mail v1.0.101 // indirect
	github.com/wopta/goworkspace/sellable v1.0.80 // indirect
