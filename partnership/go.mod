...
require (
	...
	github.com/wopta/goworkspace/quote v1.0.62
	github.com/wopta/goworkspace/user v1.0.87
)
...
require (
	...
	github.com/wopta/goworkspace/mail v1.0.102 // indirect
	github.com/wopta/goworkspace/sellable v1.0.81 // indirect
