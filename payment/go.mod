...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.111
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.110
	gitlab.dev.wopta.it/goworkspace/document v1.1.247
