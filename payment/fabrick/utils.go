			...
			Subjects: &[]models.FabrickSubject{
				{
					...
					Name:       strings.Join([]string{policy.Contractor.Name, policy.Contractor.Surname, policy.Contractor.CompanyName}, " "),
					Surname:    strings.Join([]string{policy.Contractor.Surname, policy.Contractor.CompanyName}, " "),
				},
			},
		},
	}
