...
require (
	...
	gitlab.dev.wopta.it/goworkspace/quote v1.0.349
)
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/models v1.2.157 // indirect
	gitlab.dev.wopta.it/goworkspace/network v1.0.225 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.364 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.156 // indirect
	gitlab.dev.wopta.it/goworkspace/sellable v1.0.270 // indirect
