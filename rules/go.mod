...
require (
	...
	gitlab.dev.wopta.it/goworkspace/quote v1.0.226
)
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/models v1.2.70 // indirect
	gitlab.dev.wopta.it/goworkspace/network v1.0.136 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.246 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.69 // indirect
	gitlab.dev.wopta.it/goworkspace/sellable v1.0.177 // indirect
