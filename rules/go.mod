...
require (
	...
	gitlab.dev.wopta.it/goworkspace/quote v1.0.305
)
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/models v1.2.120 // indirect
	gitlab.dev.wopta.it/goworkspace/network v1.0.188 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.320 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.119 // indirect
	gitlab.dev.wopta.it/goworkspace/sellable v1.0.233 // indirect
