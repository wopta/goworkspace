...
require (
	...
	gitlab.dev.wopta.it/goworkspace/quote v1.0.270
)
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/models v1.2.97 // indirect
	gitlab.dev.wopta.it/goworkspace/network v1.0.165 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.288 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.96 // indirect
