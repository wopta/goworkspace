...
require (
	...
	gitlab.dev.wopta.it/goworkspace/quote v1.0.329
)
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/models v1.2.137 // indirect
	gitlab.dev.wopta.it/goworkspace/network v1.0.205 // indirect
	...
	gitlab.dev.wopta.it/goworkspace/sellable v1.0.250 // indirect
