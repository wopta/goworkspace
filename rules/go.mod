...
require (
	...
	gitlab.dev.wopta.it/goworkspace/models v1.2.79 // indirect
	gitlab.dev.wopta.it/goworkspace/network v1.0.147 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.264 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.78 // indirect
