...
require (
	...
	gitlab.dev.wopta.it/goworkspace/quote v1.0.259
)
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/document v1.1.236 // indirect
	gitlab.dev.wopta.it/goworkspace/models v1.2.90 // indirect
	gitlab.dev.wopta.it/goworkspace/network v1.0.158 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.279 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.89 // indirect
	gitlab.dev.wopta.it/goworkspace/sellable v1.0.199 // indirect
