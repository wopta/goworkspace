...
require (
	...
	gitlab.dev.wopta.it/goworkspace/quote v1.0.327
)
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/document v1.1.298 // indirect
	gitlab.dev.wopta.it/goworkspace/models v1.2.136 // indirect
	gitlab.dev.wopta.it/goworkspace/network v1.0.204 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.342 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.135 // indirect
	gitlab.dev.wopta.it/goworkspace/question v1.0.190 // indirect
	gitlab.dev.wopta.it/goworkspace/sellable v1.0.249 // indirect
