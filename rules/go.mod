...
require (
	...
	gitlab.dev.wopta.it/goworkspace/quote v1.0.271
)
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/models v1.2.98 // indirect
	gitlab.dev.wopta.it/goworkspace/network v1.0.166 // indirect
	gitlab.dev.wopta.it/goworkspace/policy v1.0.289 // indirect
	gitlab.dev.wopta.it/goworkspace/product v1.1.97 // indirect
	gitlab.dev.wopta.it/goworkspace/sellable v1.0.208 // indirect
