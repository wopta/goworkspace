...
func initCoverage() map[string]*Coverage {
	...
	res["damage-to-goods-in-custody"] = &Coverage{
		...
		Deductible:                 "0",
		SelfInsuranceDesc:          "",
		Description:                "Per responsabilità relative a danni a veicoli in consegna, custodia o comunque detenuti, compresa errata erogazione di carburante, riparazione e manutenzione o movimentazione/caduta ponte sollevamento, fino a 50.000 Euro",
		Tax:                        22.25,
	...
	res["defect-liability-workmanships"] = &Coverage{
		...
		SelfInsurance:              "0",
		SelfInsuranceDesc:          "",
		Description:                `Per danni dopo l'ultimazione dei lavori, subiti o causati da veicoli a motore riparati, revisionati o manutenuti, compresi interventi su pneumatici, fino al 10% del massimale RCT`,
		Tax:                        22.25,
		Deductible:                 "0",
		SumInsuredLimitOfIndemnity: 0,
		IsBase:                     false,
	...
	res["defect-liability-12-months"] = &Coverage{
		...
		SelfInsurance:              "0",
		SelfInsuranceDesc:          "",
		Description:                "Per danni  in qualità di installatore, manutentore o riparatore, causati dopo ultimazione lavori dalle cose installate, riparate o manutenute (NO Ateco Edili 41. 42. 43.), fino al 10% del massimale RCT",
		Tax:                        22.25,
		SumInsuredLimitOfIndemnity: 0,
		IsBase:                     false,
		IsYuor:                     false,
	...
	res["defect-liability-dm-37-2008"] = &Coverage{
		...
		Tax:                        22.25,
		SelfInsuranceDesc:          "",
		Description:                "Per danni  in qualità di installatore, manutentore o riparatore, causati dopo ultimazione lavori dalle cose installate, riparate o manutenute (Solo per Ateco Edili e attività soggette a DM 37/2008), fino al 10% del massimale RCT",
		SumInsuredLimitOfIndemnity: 0,
		IsBase:                     false,
		IsYuor:                     false,
		IsPremium:                  false,
	...
	res["property-damage-due-to-theft"] = &Coverage{
		...
		SelfInsurance:              "0",
		SelfInsuranceDesc:          "",
		Description:                "Per danni da furto commesso da soggetti che abbiano utilizzato impalcature, attrezzature fisse o ponteggi eretti o fatti erigere dall'assicurato, fino a 50.000 Euro",
		SumInsuredLimitOfIndemnity: 0,
		Tax:                        22.25,
		IsBase:                     false,
		IsYuor:                     false,
	...
	res["damage-to-goods-course-of-works"] = &Coverage{
		...
		TypeOfSumInsured:           "",
		SelfInsuranceDesc:          "",
		Description:                "Per danni alle cose di terzi sulle quali si eseguono i lavori, fino a 15.000 Euro",
		Deductible:                 "0",
		Tax:                        22.25,
		SumInsuredLimitOfIndemnity: 0,
		SelfInsurance:              "0",
	...
	res["third-party-liability-construction-company"] = &Coverage{
		...
		SumInsuredLimitOfIndemnity: 0,
		SelfInsuranceDesc:          "",
		Description:                "Pacchetto di garanzie che include i danni, fino a 50.000 Euro: 1) a condutture o impianti sotterranei; 2) da cedimento e franamento del terreno; 3) da bagnamento e spargimento d'acqua",
		Tax:                        22.25,
		IsBase:                     false,
		IsYuor:                     false,
		IsPremium:                  false,
	...
	res["atmospheric-event"] = &Coverage{
		...
		SelfInsurance:              "0",
		SelfInsuranceDesc:          "",
		Description:                "Danni, fino al 100% delle somme assicurate, da eventi atmosferici quali uragano, bufera, tempesta, grandine, vento e cose trascinate da esso, tromba d’aria, gelo, sovraccarico di neve",
		Tax:                        22.25,
		SumInsuredLimitOfIndemnity: 0,
		IsBase:                     false,
		IsYuor:                     false,
	...
	res["sociopolitical-event"] = &Coverage{
		...
		SelfInsurance:              "0",
		SelfInsuranceDesc:          "",
		Description:                "Danni, fino all'80% delle somme assicurate, da eventi sociopolitici, quali tumulti popolari, scioperi, sommosse, atti vandalici o dolosi e atti di sabotaggio",
		SumInsuredLimitOfIndemnity: 0,
		Tax:                        22.25,
		IsBase:                     false,
		IsYuor:                     false,
	...
	res["terrorism"] = &Coverage{
		...
		SelfInsurance:              "0",
		SelfInsuranceDesc:          "",
		Description:                "Danni, fino al 50% delle somme assicurate, da atti di terrorismo",
		Tax:                        22.25,
		SumInsuredLimitOfIndemnity: 0,
		IsBase:                     false,
		IsYuor:                     false,
	...
	res["earthquake"] = &Coverage{
		...
		SelfInsurance:              "0",
		SelfInsuranceDesc:          "",
		Description:                "Danni, fino al 70% delle somme assicurate, da terremoto ai beni assicurati  compresi quelli di Incendio, Esplosione, Scoppio",
		SumInsuredLimitOfIndemnity: 0,
		Tax:                        22.25,
		IsBase:                     false,
		IsYuor:                     false,
	...
	res["river-flood"] = &Coverage{
		...
		SelfInsurance:              "0",
		SelfInsuranceDesc:          "",
		Description:                "Danni, fino al 70% delle somme assicurate, da alluvione/inondazione (allagamento di un territorio causato da straripamento, esondazione, tracimazione o fuoriuscita dagli argini di corsi d’acqua, da laghi e bacini, sia naturali sia artificiali, anche se derivanti da eventi atmosferici.",
		SumInsuredLimitOfIndemnity: 0,
		Tax:                        22.25,
		IsBase:                     false,
		IsYuor:                     false,
	...
	res["water-damage"] = &Coverage{
		...
		Deductible:                 "0",
		SelfInsuranceDesc:          "",
		Description:                "Danni, fino al 70% delle somme assicurate, da allagamento (eccesso o accumulo d’acqua in luogo normalmente asciutto) verificatosi all'interno del Fabbricato a seguito di formazione di ruscelli o accumulo esterno di acqua",
		Tax:                        22.25,
		SumInsuredLimitOfIndemnity: 0,
		IsBase:                     false,
		IsYuor:                     false,
