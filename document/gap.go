...
func gapHeader(pdf *fpdf.Fpdf, policy *models.Policy) {
	...
	logoPath = folderPath + "logo_gap.png"
	...
	pdf.SetHeaderFunc(func() {
		...
		pdf.ImageOptions(folderPath+"logo_wopta.png", 115, 6.5, 0, 8, false, opt, 0, "")
		pdf.SetX(pdf.GetX() + 96.5)
		pdf.SetDrawColor(229, 0, 117)
		pdf.SetLineWidth(0.5)
		pdf.Line(pdf.GetX(), 6, pdf.GetX(), 15.25)
		pdf.ImageOptions(folderPath+"logo_sogessur.png", 146, 7.5, 0, 6, false, opt, 0, "")
...
func woptaGapHeader(pdf *fpdf.Fpdf, policy models.Policy) {
	...
	pdf.SetHeaderFunc(func() {
		...
		opt.ImageType = "png"
		pdf.ImageOptions(folderPath+"logo_wopta.png", 11, 6, 0, 10,
			false, opt, 0, "")
