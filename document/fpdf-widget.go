...
func mainHeader(pdf *fpdf.Fpdf, policy *models.Policy) {
	...
	case models.LifeProduct:
		logoPath = GetAssetPathByEnvV2() + "logo_vita.png"
		productName = "Vita"
		policyInfo += expiryInfo + "Non si rinnova a scadenza."
	case models.PmiProduct:
		logoPath = GetAssetPathByEnvV2() + "logo_pmi.png"
		productName = "Artigiani & Imprese"
	case models.PersonaProduct:
		logoPath = GetAssetPathByEnvV2() + "logo_persona.png"
		productName = "Persona"
	...
	pdf.SetHeaderFunc(func() {
		...
		log.Printf("[logo_wopta] path: %s", GetAssetPathByEnvV2()+"logo_wopta.png")
		pdf.ImageOptions(GetAssetPathByEnvV2()+"logo_wopta.png", 170, 6, 0, 8, false, opt, 0, "")
...
func mainFooter(pdf *fpdf.Fpdf, productName string) {
	...
	case models.LifeProduct:
		...
		logoPath = GetAssetPathByEnvV2() + "logo_axa.png"
		x = 190
		y = 282.5
		height = 8
	case models.PmiProduct:
	...
	case models.PersonaProduct:
		...
		logoPath = GetAssetPathByEnvV2() + "logo_global.png"
		x = 180
		y = 280
		height = 10
	case models.GapProduct:
		...
		logoPath = GetAssetPathByEnvV2() + "logo_sogessur.png"
		x = 183
		y = 285
		height = 3
	}
...
func axaHeader(pdf *fpdf.Fpdf) {
	pdf.SetHeaderFunc(func() {
		...
		pdf.SetXY(-30, 7)
		opt.ImageType = "png"
		pdf.ImageOptions(GetAssetPathByEnvV2()+"logo_axa.png", 190, 7, 0, 8, false, opt, 0, "")
		pdf.Ln(15)
	})
}
...
func sogessurHeader(pdf *fpdf.Fpdf) {
	pdf.SetHeaderFunc(func() {
		...
		pdf.SetXY(-30, 7)
		opt.ImageType = "png"
		pdf.ImageOptions(GetAssetPathByEnvV2()+"logo_sogessur.png", 160, 7, 0, 6, false,
			opt, 0, "")
		pdf.Ln(15)
	})
}
...
func woptaHeader(pdf *fpdf.Fpdf) {
	pdf.SetHeaderFunc(func() {
		var opt fpdf.ImageOptions
		opt.ImageType = "png"
		pdf.ImageOptions(GetAssetPathByEnvV2()+"logo_wopta.png", 10, 6, 0, 10,
			false, opt, 0, "")
		pdf.Ln(10)
	})
}
...
func globalHeader(pdf *fpdf.Fpdf) {
	pdf.SetHeaderFunc(func() {
		...
		pdf.SetXY(-30, 7)
		opt.ImageType = "png"
		pdf.ImageOptions(GetAssetPathByEnvV2()+"logo_global_02.png", 180, 7, 0, 15, false, opt, 0, "")
		pdf.Ln(15)
	})
}
...
func companySignature(pdf *fpdf.Fpdf, companyName string) {
	...
	case "global":
		...
		pdf.ImageOptions(GetAssetPathByEnvV2()+"signature_global.png", 25, pdf.GetY()+3, 40, 12,
			false, opt, 0, "")
	case "axa":
		setBlackBoldFont(pdf, standardTextSize)
		...
		pdf.SetY(pdf.GetY() - 6)
		pdf.ImageOptions(GetAssetPathByEnvV2()+"signature_axa.png", 35, pdf.GetY()+9, 30, 8,
			false, opt, 0, "")
	case "sogessur":
		setBlackBoldFont(pdf, standardTextSize)
		pdf.MultiCell(70, 3, "Sogessur SA\n(Rappresentanza Generale per l'Italia)", "",
			fpdf.AlignCenter, false)
		pdf.SetY(pdf.GetY() - 6)
		pdf.ImageOptions(GetAssetPathByEnvV2()+"signature_sogessur.png", 40, pdf.GetY()+9, 10, 10,
			false, opt, 0, "")
	}
}
