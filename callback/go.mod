...
require (
	...
	gitlab.dev.wopta.it/goworkspace/bpmn v1.0.44
	gitlab.dev.wopta.it/goworkspace/callback_out v1.0.75
	...
	gitlab.dev.wopta.it/goworkspace/policy v1.0.232
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.52 // indirect
	gitlab.dev.wopta.it/goworkspace/document v1.1.188 // indirect
