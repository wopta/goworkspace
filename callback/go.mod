...
require (
	...
	gitlab.dev.wopta.it/goworkspace/payment v1.0.348
	gitlab.dev.wopta.it/goworkspace/policy v1.0.211
...
require (
	...
	gitlab.dev.wopta.it/goworkspace/accounting v1.0.30 // indirect
